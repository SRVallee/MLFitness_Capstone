...
public class TraineeTrim extends AppCompatActivity {
        ...
        if (resultCode == RESULT_OK) {
            if (requestCode == REQUEST_VIDEO_TRIMMER) {
                ...
                if (selectedUri != null) {
                    ...
                    Toast.makeText(TraineeTrim.this, R.string.toast_cannot_retrieve_selected_video, Toast.LENGTH_SHORT).show();
                }
            }
        }
    }
        ...
        if (ActivityCompat.shouldShowRequestPermissionRationale(this, permission)) {
            ...
            builder.setPositiveButton(getString(R.string.label_ok), new DialogInterface.OnClickListener() {
                ...
                public void onClick(DialogInterface dialog, int which) {
                    ActivityCompat.requestPermissions(TraineeTrim.this, new String[]{permission}, requestCode);
                }
            });
