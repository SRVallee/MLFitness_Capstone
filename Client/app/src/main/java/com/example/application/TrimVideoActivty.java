...
public class TrimVideoActivty extends AppCompatActivity implements OnTrimVideoListener, OnK4LVideoListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (extraIntent != null) {
            path = extraIntent.getStringExtra(Trimmer.VideoUri);
        }
        ...
        if (mVideoTrimmer != null) {
            ...
            mVideoTrimmer.setOnTrimVideoListener(this);
            mVideoTrimmer.setDestinationPath("/storage/emulated/0/"); //Just a general place for rn
    ...
    public void getResult(final Uri uri) {
       ...
       /* Intent intent = new Intent(Intent.ACTION_VIEW, uri);
        ...
        intent.putExtra(Trimmer.VideoUri,uri.toString());
        startActivity(intent);
