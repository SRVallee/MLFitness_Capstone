...
CREATE TABLE `exercise` (
  ...
  `demo_location` char(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci NOT NULL,
  `model_location` char(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci NOT NULL,
...
INSERT INTO `relationships` VALUES (1,5,6,'wherever that is',1,'2023-03-27',NULL);
...
INSERT INTO `trainer` VALUES (5,'No credatials yet','/yes/here',0,NULL);
...
INSERT INTO `user` VALUES (5,'trainer','password','trainer guy','trainer@test.test',1,'123'),(6,'not_trainer','password','trainee guy','trainee@test.test',0,'123'),(7,'not_trainer2','password','trainee guy2','trainee2@test.test',0,'123');
...
-- Dump completed on 2023-03-28  0:00:07
