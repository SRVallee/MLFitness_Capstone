...
CREATE TABLE `exercise` (
  ...
  `demo_location` char(50) NOT NULL,
  `model_location` char(50) NOT NULL,
  `notes` text,
...
CREATE TABLE `feedback_image` (
  ...
  `feedback_id` int NOT NULL,
  `image_location` char(50) NOT NULL,
...
CREATE TABLE `trainer` (
  ...
  `credentials` char(100) NOT NULL,
  `reviews_location` char(50) NOT NULL,
...
--
-- Dumping routines for database 'mlfitness'
--
...
-- Dump completed on 2023-03-03 22:38:28
