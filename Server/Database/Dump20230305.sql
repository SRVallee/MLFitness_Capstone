...
CREATE TABLE `exercise` (
  ...
  `exercise` char(50) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NOT NULL,
  `demo_location` char(50) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NOT NULL,
  `model_location` char(50) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NOT NULL,
  `notes` text CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci,
  PRIMARY KEY (`exercise_id`),
  KEY `fk_exercise_trainer1_idx` (`trainer_id`),
  CONSTRAINT `fk_exercise_trainer1` FOREIGN KEY (`trainer_id`) REFERENCES `trainer` (`trainer_id`)
...
CREATE TABLE `feedback_image` (
  ...
  `feedback_id` int NOT NULL,
  `image_location` char(50) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NOT NULL,
...
CREATE TABLE `relationships` (
  ...
  `log_location` char(50) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NOT NULL,
...
CREATE TABLE `trainer` (
  ...
  `credentials` char(100) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NOT NULL,
  `reviews_location` char(50) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NOT NULL,
  `ratings_amount` int NOT NULL,
  `rating` float DEFAULT NULL,
  PRIMARY KEY (`trainer_id`),
  KEY `fk_trainer_user1_idx` (`trainer_id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `user` (
  ...
  `api_key` tinytext COLLATE utf8mb4_general_ci,
  PRIMARY KEY (`user_id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
-- Dump completed on 2023-03-05 21:38:36
