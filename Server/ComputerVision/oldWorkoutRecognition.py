...
def getKeyFramesFromVideo(video, show = False):
    ...
    extracted, allangles, keyAngles = KeyframeExtraction.extractFrames(allFrames, rSquared, True)
...
def evaluateVideo(videoPath, modelName, repNumber = 9999, debug = None):
    extracted, allAngles = getKeyFramesFromVideo(videoPath)
    keypointAngles = []
...
if __name__ == "__main__":
    ...
    while choice != "4":
        if choice == "1":
            ...
            updateModelV1(video, name, 9999, True)
